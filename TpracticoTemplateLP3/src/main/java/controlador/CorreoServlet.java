...
public class CorreoServlet extends HttpServlet {
 ...
 String recipientEmail = request.getParameter("inputEmail");
        ...
        // Aquí debes agregar la lógica para enviar el correo electrónico
        // Puedes utilizar la clase EmailSender o cualquier otra que desees

        // Por ejemplo, puedes hacer algo como esto:
        try {
            EmailSender.sendEmailWithLink(recipientEmail);
             
            request.setAttribute("emailEnviadoExitosamente", true);
