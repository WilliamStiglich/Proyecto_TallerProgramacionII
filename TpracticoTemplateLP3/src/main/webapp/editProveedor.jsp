                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="container py-4">
                                        ...
                                        <%
                                            List<Proveedor> list = (ArrayList<Proveedor>) request.getAttribute("list");
                                        ...
                                        <form method="post" action="Controlador?accion=editProveedor">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Id de la Categoria:</label>
                                                <input type="text" class="form-control" id="txt_Id_prove" name="txt_Id_prove" maxlength="10" value="<%= prove.getId_proveedor()%>"readonly>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Categoria a editar:</label>
                                                <input type="text" class="form-control" id="txtProvee" name="txtProvee" maxlength="100" value="<%= prove.getProveedor()%>">
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Categoria a editar:</label>
                                                <input type="text" class="form-control" id="txtRuc" name="txtRuc" maxlength="100" value="<%= prove.getRuc()%>">
                                            </div>
                                            <hr>
                                            <hr>
                                        ...
                                        <a href="paises.jsp"> Volver a la Lista de Paises</a>
                                    </div>
