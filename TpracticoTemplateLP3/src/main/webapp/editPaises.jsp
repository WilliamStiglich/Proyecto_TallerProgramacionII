                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="container py-4">
                                        ...
                                        <%
                                            List<Paises> list = (ArrayList<Paises>) request.getAttribute("list");
                                        ...
                                        <form method="post" action="Controlador?accion=editPaises">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Id de la Categoria:</label>
                                                <input type="text" class="form-control" id="txtIdcateg" name="txtIdcateg" maxlength="10" value="<%= pa.getId_pais()%>"readonly>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Categoria a editar:</label>
                                                <input type="text" class="form-control" id="txtCateg" name="txtCateg" maxlength="100" value="<%= pa.getPais()%>">
                                            </div>
                                            <hr>
                                            <hr>
