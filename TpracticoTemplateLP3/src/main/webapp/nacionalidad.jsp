...
<html>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="productos.jsp">Menu Cargos</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h5 class="mt-4">Ir a Lista de Cargos</h5>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <h1>Registrar Nueva Nacionalidad</h1>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="alert alert-success" role="alert"> 
                                    Nacionalidad insertada con éxito!
                                </div>
                                ...
                                <table class="table table-hover">
                                    <form method="post" action="Controlador?accion=insertNac">
                                        <div class="form-group">
                                            <p class="font-weight-bold"><label for="formGroupExampleInput">Nueva Nacionalidad:</label></p>
                                            <input type="text" class="form-control" id="txtNac" name="txtNac" placeholder="Ingrese Nacionalidad">
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">ID de Nacionalidad</th>
                                                ...
                                                <%
                                                    ...
                                                    List<Nacionalidad> list = dao.cargaNacionalidad();
                                                    Iterator<Nacionalidad> iter = list.iterator();
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><%= nac.getId_nacionalidad()%></th>
                                                        <td><%= nac.getNacionalidad()%></td>


                                                        <td>
                                                            <a class="btn btn-warning" href="Controlador?accion=getid_Nac&id=<%= nac.getId_nacionalidad()%>" 
                                                               onclick="return confirm('¿Desea Editar los datos?');"
                                                               role="button">Editar</a>
                                                            <a class="btn btn-danger" 
                                                               href="Controlador?accion=deleteNac&id=<%= nac.getId_nacionalidad()%>"  
