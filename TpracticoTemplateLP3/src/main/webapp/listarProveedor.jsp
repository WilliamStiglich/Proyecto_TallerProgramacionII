                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <%
                                    ...
                                    List<Proveedor> list = dao.listaDeProveedores();
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><%= prove.getId_proveedor()%></th>
                                        <td><%= prove.getProveedor()%></td>
                                        <td><%= prove.getRuc()%></td>
                                        <td>
                                            <a class="btn btn-warning" href="Controlador?accion=getidProveedor&id=<%= prove.getId_proveedor()%>" 
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger" 
                                               href="Controlador?accion=deleteProveedor&id=<%= prove.getId_proveedor()%>" 
