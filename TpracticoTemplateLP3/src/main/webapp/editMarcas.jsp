...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="#">Editar Marcas</a>
            <!-- Sidebar Toggle-->
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="container py-4">
                                        <h1>Editar Marcas</h1>
                                        <%
                                            List<Marcas> list = (ArrayList<Marcas>) request.getAttribute("list");
                                        ...
                                        <form method="post" action="Controlador?accion=editMarcas">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Id de la Marca:</label>
                                                <input type="text" class="form-control" id="txtidmarca" name="txtIdmarca" maxlength="10" value="<%= mar.getId_marca()%>"readonly>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Marca a editar:</label>
                                                <input type="text" class="form-control" id="txtMarca" name="txtMarca" maxlength="100" value="<%= mar.getMarca()%>">
                                            </div>
                                            <hr>
                                            <hr>
                                        ...
                                        <a href="marcas.jsp"> Volver a la Lista de Marcas</a>
                                    </div>
