                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="container py-4">
                                        ...
                                        <%
                                            List<Categoria> list = (ArrayList<Categoria>) request.getAttribute("list");
                                        ...
                                        <form method="post" action="Controlador?accion=editCategoria">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Id de la Categoria:</label>
                                                <input type="text" class="form-control" id="txtIdcateg" name="txtIdcateg" maxlength="10" value="<%= categ.getId_categoria()%>"readonly>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Categoria a editar:</label>
                                                <input type="text" class="form-control" id="txtCateg" name="txtCateg" maxlength="100" value="<%= categ.getCategoria()%>">
                                            </div>
                                            <hr>
                                            <hr>
                                        ...
                                        <a href="categorias.jsp"> Volver a la Lista de Categorias</a>
                                    </div>
