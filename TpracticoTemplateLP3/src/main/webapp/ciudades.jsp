                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    <form method="post" action="Controlador?accion=insertCiudad">
                                        <div class="form-group">
                                            <p class="font-weight-bold"><label for="formGroupExampleInput">Nueva Ciudad:</label></p>
                                            <input type="text" class="form-control" id="txtCiudad" name="txtCiudad" placeholder="Ingrese la Ciudad">
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <%
                                                    ...
                                                    List<Ciudad> list = dao.cargaCiudad();
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><%= ciu.getId_ciudad()%></th>
                                                        <td><%= ciu.getCiudad()%></td>


                                                        <td>
                                                            <a class="btn btn-warning" href="Controlador?accion=getid_Ciudad&id=<%= ciu.getId_ciudad()%>" 
                                                               onclick="return confirm('¿Desea Editar los datos?');"
                                                               role="button">Editar</a>
                                                            <a class="btn btn-danger" 
                                                               href="Controlador?accion=deleteCiudad&id=<%= ciu.getId_ciudad()%>"  
