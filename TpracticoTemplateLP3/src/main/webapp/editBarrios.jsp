                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="container py-4">
                                        ...
                                        <%
                                            List<Barrio> list = (ArrayList<Barrio>) request.getAttribute("list");
                                        ...
                                        <form method="post" action="Controlador?accion=editBarrio">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Id de la Categoria:</label>
                                                <input type="text" class="form-control" id="txt_Id_Barrio" name="txt_Id_Barrio" maxlength="10" value="<%= bar.getId_barrio()%>"readonly>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Categoria a editar:</label>
                                                <input type="text" class="form-control" id="txtBarrio" name="txtBarrio" maxlength="100" value="<%= bar.getBarrio()%>">
                                            </div>
                                            <hr>
                                            <hr>
