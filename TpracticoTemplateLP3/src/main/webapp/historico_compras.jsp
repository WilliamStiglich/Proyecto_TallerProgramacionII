            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Historico de Compras</h1>
                        ...
                        <div class="delete-container">
                            ...
                            <div class="alert alert-success" role="alert">La Compra se Anulo correctamente</div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Monto Total Compra</th>
                                ...
                                <%
                                    ...
                                    List<Compras> list = dao.listarCompras();
                                    Iterator<Compras> iterc = list.iterator();
                                    Compras comp = null;
                                    while (iterc.hasNext()) {
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><%= comp.getId_compra()%></th>
                                        <td><%= comp.getProveedor()%></td>
                                        <td><%= comp.getMonto()%></td>
                                        <td><%= comp.getFecha_compra()%></td>
                                       
                                         <td>

                                            <a class="btn btn-danger" 
                                               href="Controlador?accion=AnularCompra&id=<%= comp.getId_compra()%>" 
                                               onclick="return confirm('¿Desea Anular la Compra?');"
                                               role="button">Anular</a>
                                        </td>
                                        <td>
                                            <a class="btn btn-success" 
                                               target="_blank"
                                               href="Controlador?accion=imprimirCompra&id=<%= comp.getId_compra()%>" 
