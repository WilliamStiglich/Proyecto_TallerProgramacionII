                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    <form method="post" action="Controlador?accion=insertBarrio">
                                        <div class="form-group">
                                            <p class="font-weight-bold"><label for="formGroupExampleInput">Nuevo Barrio:</label></p>
                                            <input type="text" class="form-control" id="txtBarrio" name="txtBarrio" placeholder="Ingrese el Barrio">
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <%
                                                    ...
                                                    List<Barrio> list = dao.cargaBarrio();
                                                    Iterator<Barrio> iter = list.iterator();
                                                    Barrio ba = null;
                                                    while (iter.hasNext()) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><%= ba.getId_barrio()%></th>
                                                        <td><%= ba.getBarrio()%></td>


                                                        <td>
                                                            <a class="btn btn-warning" href="Controlador?accion=getid_Barrio&id=<%= ba.getId_barrio()%>" 
                                                               onclick="return confirm('¿Desea Editar los datos?');"
                                                               role="button">Editar</a>
                                                            <a class="btn btn-danger" 
                                                               href="Controlador?accion=deleteBarrio&id=<%= ba.getId_barrio()%>"  
