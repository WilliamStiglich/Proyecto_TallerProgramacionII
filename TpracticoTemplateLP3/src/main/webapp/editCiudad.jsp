                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="container py-4">
                                        ...
                                        <%
                                            List<Ciudad> list = (ArrayList<Ciudad>) request.getAttribute("list");
                                        ...
                                        <form method="post" action="Controlador?accion=editCiudad">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Id Nacionalidad</label>
                                                <input type="text" class="form-control" id="txt_Id_Ciudad" name="txt_Id_Ciudad" maxlength="10" value="<%= ciu.getId_ciudad()%>"readonly>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Nacionalidad a editar:</label>
                                                <input type="text" class="form-control" id="txtCiudad" name="txtCiudad" maxlength="100" value="<%= ciu.getCiudad()%>">
                                            </div>
                                            <hr>
                                            <hr>
