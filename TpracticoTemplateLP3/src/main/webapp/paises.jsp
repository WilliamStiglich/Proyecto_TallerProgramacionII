                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    <form method="post" action="Controlador?accion=insertPais">
                                        <div class="form-group">
                                            <p class="font-weight-bold"><label for="formGroupExampleInput">Nuevo Pais:</label></p>
                                            <input type="text" class="form-control" id="txtPais" name="txtPais" placeholder="Ingrese el Pais">
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <%
                                                    ...
                                                    List<Paises> list = dao.cargaPais();
                                                    Iterator<Paises> iter = list.iterator();
                                                    Paises pa = null;
                                                    while (iter.hasNext()) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><%= pa.getId_pais()%></th>
                                                        <td><%= pa.getPais()%></td>


                                                        <td>
                                                            <a class="btn btn-warning" href="Controlador?accion=getid_Pais&id=<%= pa.getId_pais()%>" 
                                                               onclick="return confirm('¿Desea Editar los datos?');"
                                                               role="button">Editar</a>
                                                            <a class="btn btn-danger" 
                                                               href="Controlador?accion=deletePais&id=<%= pa.getId_pais()%>"  
