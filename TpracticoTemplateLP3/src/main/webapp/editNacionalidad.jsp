                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <div class="container py-4">
                                        ...
                                        <%
                                            List<Nacionalidad> list = (ArrayList<Nacionalidad>) request.getAttribute("list");
                                        ...
                                        <form method="post" action="Controlador?accion=editNacion">
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Id Nacionalidad</label>
                                                <input type="text" class="form-control" id="txt_Id_Nac" name="txt_Id_Nac" maxlength="10" value="<%= nac.getId_nacionalidad()%>"readonly>
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">Nacionalidad a editar:</label>
                                                <input type="text" class="form-control" id="txtNacion" name="txtNacion" maxlength="100" value="<%= nac.getNacionalidad()%>">
                                            </div>
                                            <hr>
                                            <hr>
